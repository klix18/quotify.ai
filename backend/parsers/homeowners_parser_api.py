...
def stream_homeowners_quote_with_gemini(
    ...
    try:
        ...
        quick_text = ""
        quick_user_prompt = "Quickly extract likely fields from this homeowners quote PDF."
        ...
        full_text = ""
        final_user_prompt = "Extract the homeowners insurance quote fields from this PDF."
...
async def parse_homeowners_quote(file: UploadFile = File(...)):
    ...
    try:
        await store_uploaded_pdf(
            ...
            file_name=file.filename or "homeowners_quote.pdf",
