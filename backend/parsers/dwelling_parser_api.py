...
def stream_dwelling_quote_with_gemini(
    ...
    try:
        ...
        draft_bullets = generate_why_selected_draft(draft_data, "dwelling")
        if draft_bullets:
        ...
        data["why_selected"] = generate_why_selected_refine(data, draft_bullets, "dwelling")
