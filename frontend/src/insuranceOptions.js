export const INSURANCE_OPTIONS = [
  ...
  export const INSURANCE_HEADER_MAP = {
    bundle: "Bundle Insurance Information",
    homeowners: "Homeowners Insurance Information",
    auto: "Auto Insurance Information",
    dwelling: "Dwelling Insurance Information",
    commercial: "Commercial Insurance Information",
